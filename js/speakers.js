...
// Clear the MDL grid of all of the speaker cards on the page
...
// Show the speakers that have been already created for a given year
...
// Load all of the speakers for the year, given that the content has not been loaded before
