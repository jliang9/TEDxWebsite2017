...
var SPEAKER_DB = {
    2017: [
        ...
        },
        {
            ...
            "speech": "",
            "video": "",
            "desc": "Courtney Sheehan is executive director for Northwest Film Forum, Seattle's independent film nonprofit. Courtney has curated film programs and produced events for theaters and festivals on three continents. On a year-long Watson Fellowship, Courtney investigated the organizational structures, community roles, and programming strategies of twenty film festivals and media centers in India, Spain, the Netherlands, Brazil, Bosnia-Herzegovina, Croatia, Serbia and Macedonia. As a journalist, Courtney has covered film events ranging from the world’s largest documentary festival (IDFA in Amsterdam) to South America’s largest animation festival (Anima Mundi in Rio de Janeiro). She also co-founded Cine Migratorio, a migration-themed film festival in Santander, Spain, and the Seventh Art Stand, a national series of films from the countries and people affected by the travel bans."
        },
        {
            "name": "Rachel Marshall",
            "speech": "",
            "video": "",
            "desc": "After a five-year post-collegiate stint living in the Bavarian Alps, Rachel Marshall returned home to Seattle and realized something. It was impossible to find the kind of ginger beer she’d fallen in love with abroad—bold, acidic, fresh, and not cloyingly sweet. She founded the eponymous Rachel’s Ginger Beer in 2011, along with partner Adam Peters, whom she met and fell in love with in those beautiful alps. Working in borrowed kitchen space, Rachel created a beverage meant to play nicely with your favorite spirit—from vodka to tequila to bourbon—but serve you just as well the morning after. The company’s workspace has since turned into a 10,000-square- foot production plant in SoDo and Rachel has since parlayed 20 years of hospitality experience into her true passion: Creating beautiful spaces for friends to gather, over a cocktail, a ginger beer float, or just a glass of one of RGB’s seasonal flavors, like cucumber tarragon or blood orange. Marshall also co-owns two bars in the Capitol Hill neighborhood, Nacho Borracho and Montana, which was the first establishment in town to serve cocktails on tap, a development that speeds up drink delivery for customers and makes for a saner, more efficient shift for anyone working the bar. Since its humble, self-funded (read: poorly funded) inception as a stand in Seattle farmers markets, RGB has grown to four stores in Seattle and Portland, hundreds of wholesale accounts, as well as nationwide shipping, all with a fan base to match."
        }
    ],
    2016: [
        {
